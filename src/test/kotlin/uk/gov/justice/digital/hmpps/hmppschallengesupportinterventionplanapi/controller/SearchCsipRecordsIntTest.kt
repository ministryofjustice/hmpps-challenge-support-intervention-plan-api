...
class SearchCsipRecordsIntTest : IntegrationTestBase() {
  ...
  fun `200 ok - can sort by fields`() {
    ...
    verifySort(prisonCode, "nextReviewDate", listOf(csip4, csip1, csip2, csip3), listOf(csip1, csip4, csip2, csip3))
    verifySort(prisonCode, "status", listOf(csip2, csip4, csip1, csip3), listOf(csip3, csip4, csip1, csip2))
    verifySort(prisonCode, "caseManager", listOf(csip4, csip1, csip2, csip3), listOf(csip1, csip4, csip2, csip3))
  }
