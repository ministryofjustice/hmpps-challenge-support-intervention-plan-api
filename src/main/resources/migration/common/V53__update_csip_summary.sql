...
create index if not exists idx_csip_record_status_id on csip_record (status_id);
create index if not exists idx_referral_referral_date on referral (referral_date);
create index if not exists idx_person_summary_prison_code on person_summary (prison_code);
create index if not exists idx_person_summary_prison_code on person_summary (supporting_prison_code);