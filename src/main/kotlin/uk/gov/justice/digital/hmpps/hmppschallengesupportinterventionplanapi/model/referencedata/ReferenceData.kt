...
@Schema(description = "A reference data code to categorise various aspects related to a CSIP record")
data class ReferenceData(
  @Schema(description = "The short code of a reference data")
  val code: String,

  @Schema(description = "The description of the reference data code")
