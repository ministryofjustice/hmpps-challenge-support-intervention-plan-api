...
enum class DomainEventType(
  ...
  CONTRIBUTORY_FACTOR_CREATED("person.csip.contributory-factor.created", "A Contributory factor has been created in the CSIP service"),
  INTERVIEW_CREATED("person.csip.interview.created", "A Interview record has been created in the CSIP service"),
}
