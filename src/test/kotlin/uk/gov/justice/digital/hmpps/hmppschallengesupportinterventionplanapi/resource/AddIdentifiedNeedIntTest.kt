...
import uk.gov.justice.digital.hmpps.hmppschallengesupportinterventionplanapi.enumeration.DomainEventType.IDENTIFIED_NEED_DELETED
...
class AddIdentifiedNeedIntTest : IntegrationTestBase() {
  ...
  fun `201 created - identified need added DPS`() {
    ...
    verifyAudit(record, AuditEventAction.CREATED, setOf(AffectedComponent.IdentifiedNeed), need.auditDescription())
